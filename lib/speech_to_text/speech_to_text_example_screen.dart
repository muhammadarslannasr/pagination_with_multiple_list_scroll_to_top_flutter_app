...
class SpeechToTextExampleScreen extends StatefulWidget {
  const SpeechToTextExampleScreen({super.key});

  @override
  State<SpeechToTextExampleScreen> createState() => _SpeechToTextExampleScreenState();
}

class _SpeechToTextExampleScreenState extends State<SpeechToTextExampleScreen> {
